...
/// Generates a `<script>` that calls `Alpine.morphBetween` once on page
/// load. No event listener is attached.
public func setupMorphBetween(
    startMarker: String,
    endMarker: String,
    @HTMLBuilder returning: () -> some HTML
...
/// Generates a `<script>` that calls `Alpine.morphBetween` with lifecycle
/// hook options once on page load.
public func setupMorphBetween(
    startMarker: String,
    endMarker: String,
    options: () -> MorphOptions,
...
/// Generates a `<script>` that runs a dynamic JS pre-command and calls
/// `Alpine.morphBetween` with lifecycle hook options once on page load.
public func setupMorphBetween(
    startMarker: String,
    endMarker: String,
    options: () -> MorphOptions,
